...
| Resource group | az104-rg9-lod61700508 (If necessary, select Create new) |
| Web app name | WebApp61700508 |
| Publish | Code |
...
# 🛠️ Task 2: Create and Configure a Deployment Slot
...
# 🛠️ Task 3: Configure Web App Deployment Settings
...
# 🛠️ Task 4: Swap Deployment Slots
...
# 🛠️ Task 5: Configure and Test Autoscaling of the Azure Web App
...
Open an Edge browser and choose Copilot (top right) or navigate to copilot.microsoft.com.
